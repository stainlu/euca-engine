...
$E rule create --when timer:8 --do-action "spawn cube -7,0.5,0 blue 80 1 true -7,0,0:0,0,0:7,0,0 3 0.5,0.5,0.5 20 30 minion" 2>/dev/null
$E rule create --when timer:8 --do-action "spawn cube 7,0.5,0 red 80 2 true 7,0,0:0,0,0:-7,0,0 3 0.5,0.5,0.5 20 30 minion" 2>/dev/null
